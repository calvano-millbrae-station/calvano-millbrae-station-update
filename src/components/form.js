...
class PageForm extends Component {
  ...
  render() {
    const supportString = this.props.data.letter.text.text || ''
    return (
      <Formik
        ...
        {({ isSubmitting }) => (
          <Form>
            ...
            <Checkbox
              ...
              onClick={() =>
                this.setState({
                  isRegisterSelected: !this.state.isRegisterSelected,
                })
              }
              value={this.state.isRegisterSelected}
            />
...
export default props => (
  <StaticQuery
    query={graphql`
      query {
        letter: contentfulLetterOfSupport {
          text {
            text
          }
        }
