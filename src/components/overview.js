        ...
        <Col>
          ...
          <main>
            <article>
              ...
              <li><strong>Retail Promenade: </strong> By creatinga retail promenade, residents and commuters will experience an active people friendly paseo bridging the connection between the Downtown and the largest multimodal public transit artery in the Bay Area. The promenadeaims to spark opportunities for localsand visitorsto shopor mingle and share memories over coffee. The retail promenade will be a community anchoring amenity to the many residents and commuters.</li>

              <li><strong>Improved Pedestrian, Bike, and Transit Paths: </strong>The project will not only revitalize the immediate area, but facilitate a critical link between the station and Downtown Millbrae. From the inception, the project was contemplated from the prospective of improving transit connections and facilitation an improved experience for
residents and commuters From Millbrae Station’s, commuters will have a clear and safe path through the retail promenade, across El Camino Real to Chadbourne.</li>
              ...
              <li><strong>Increased Revenue – Transit Occupancy Tax: </strong>The project willgenerate many positive benefits for the Millbrae community. One of the most significant benefits is that the high-density hotel is estimated to generate approximately $2,000,000 per year in income to city. In addition, the project anticipates a land exchange whereby the city will own the land beneath the hotel and the applicant will land lease it. When the term expires the city will continue to own the hotel land. This creates additional value because the city can monetize their land while retaining ownership.</li>

              <li><strong>Smart Growth: </strong>Transportation drives development, and the transportation system we build dictates the shape of real estate. For the past several decades federal transportation investments have focused primarily on building roads, as the market wanted. However, today’s real estate market is different, with consistently strong demand for homes and offices in walkable urban places—which are in short supply. We believe that our project aligns with the smart growth principles by complying with 9 out of 10 of their commandments.</li>
